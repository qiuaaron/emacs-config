...
;; Time-stamp: <2009-11-16 17:39:18 Monday by ahei>
...
(defmacro def-mark-move-command (command)
  ...
  `(defun ,(concat-name "mark-and-" command) ()
...
(defvar mark-move-commands
  `("next-line" "previous-line" "end-of-buffer" "beginning-of-buffer")
  "*Commands to be used in `def-mark-move-command'.")

(apply-args-list-to-fun 'def-mark-move-command mark-move-commands)
...
(defvar remember-commands
  `("previous-line" "next-line"
    "forward-word-or-to-word" "forward-word" "backward-word"
    "forward-char" "backward-char")
  "Commands to be used in `def-remember-command'.")

(apply-args-list-to-fun 'def-remember-command remember-commands)
...
(let ((key-pairs
       `(("C-n"     next-line-remember)
         ...
         ("M-f"     forward-word-or-to-word-remember)
