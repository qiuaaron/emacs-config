...
;; $Id: ucf-mode.el,v 1.2 2006/04/24 16:42:05 ywu Exp $
...
(defconst ucf-font-lock-keywords-1
  (list 
   '("\\<\\(inst\\|net\\|inst\\|loc\\|config\\|prohibit\\|part\\)\\>" . font-lock-keyword-face)
   '("\\<\\(tnm_net\\|tnm\\|timegrp\\|except\\|timespec\\|rising\\|falling\\)\\>" . font-lock-keyword-face)
   '("\\<\\(period\\|high\\|\\|priority\\)\\>" . font-lock-keyword-face)
   '("\\<\\(offset\\|in\\|out\\|valid\\|before\\|after\\|from\\|to\\)\\>" . font-lock-keyword-face)
   '("\\<\\(maxdelay\\|maxskew\\|tig\\|bel\\|nodelay\\)\\>" . font-lock-keyword-face)
   '("\\<\\(area_group\\|range\\|compression\\|implement\\|group\\)\\>" . font-lock-keyword-face)
   '("\\<\\(place\\|mode\\|u_set\\|route\\)\\>" . font-lock-keyword-face)
   '("\\<\\(iostandard\\|drive\\|slew\\|pullup\\|iobdelay\\)\\>" . font-lock-keyword-face)
   '("\\<\\(bypass\\|iob\\)\\>" . font-lock-keyword-face)
   '("\\<\\(rloc_origin\\|rloc\\)\\>" . font-lock-keyword-face)

   '("\\<\\(true\\|false\\|none\\|fixed\\)\\>" . font-lock-constant-face)
