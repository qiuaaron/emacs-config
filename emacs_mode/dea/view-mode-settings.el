...
;; Time-stamp: <2009-11-24 13:29:11 Tuesday by ahei>
...
(define-key view-mode-map (kbd "Q") 'kill-this-buffer)
...
(define-key view-mode-map (kbd "N") 'select-buffer-forward)
(define-key view-mode-map (kbd "P") 'select-buffer-backward)
